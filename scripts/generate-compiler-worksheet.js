...
function writeWorksheet(records, potential, gaps, confirmed, potentialQueue, gapQueue, sourceAudit, sourceNoteFinalization, accessReview, pageBoundary, chapterMatrix, personsAuthority, selectionBoard, decisionCockpit) {
  ...
  const lines = [
    ...
    "- Critical-page extraction aid: `compiler-critical-page-extractions.md` and `compiler-critical-page-extractions.csv` (generated by `scripts/extract-critical-page-boundaries.js`).",
    "",
    "## Selection Board",
    "",
    ...
    "- `compiler-critical-page-extractions.md` and `compiler-critical-page-extractions.csv`: first-pass page-finding aid for Critical boundary rows, with text-layer/OCR status and candidate pages.",
